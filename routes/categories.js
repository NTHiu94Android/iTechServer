...
//Lay tat ca category
//https://itech-server-hiuntps.onrender.com/category/api/get-all-category
router.get('/api/get-all-category', async (req, res) => {
    try {
...
//Them category
//https://itech-server-hiuntps.onrender.com/category/cpanel/add-category
